...
function draw() {
    ...
    arc(200, 500, diameter0*50, diameter0*60, PI - QUARTER_PI, QUARTER_PI, OPEN);
    
    //EYES
    ellipseMode(RADIUS);
    fill(255, 255, 255);
    ellipse(170, 480, diameter0*15, diameter0*15);
    
    ellipseMode(RADIUS);
    fill(255, 255, 255);
    ellipse(210, 480, diameter0*15, diameter0*15);
    
    ellipseMode(RADIUS);
    fill(0, 0, 255);
    ellipse(170, 472, diameter0*7, diameter0*7);
    
    ellipseMode(RADIUS);
    fill(0, 0, 255);
    ellipse(210, 472, diameter0*7, diameter0*7);

    ellipseMode(RADIUS);
    fill(255, 255, 0);
    arc(200, 100, diameter1, diameter1, QUARTER_PI, PI + HALF_PI + QUARTER_PI, PIE);
    ...
    fill(255, 170, 164);
    ellipse(1100, 100, diameter2, diameter2);
    ...
    ellipseMode(RADIUS);
    fill(255, 170, 164);
    ellipse(800, 500, diameter2, diameter2);

    ellipseMode(RADIUS);
    fill(255, 170, 164);
    ellipse(800, 600, 10, 10);

    ellipseMode(RADIUS);
    fill(255, 170, 164);
    ellipse(800, 700, 10, 10);
